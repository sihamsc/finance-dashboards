...
ACCENT_COLORS = ["#d7f34a", "#4ade80", "#60a5fa", "#f472b6", "#fb923c", "#a78bfa", "#34d399"]
BLUE_GRADIENT = ["#17324d", "#1f4e79", "#2b6ea5", "#60a5fa"]
...
with tab1:
    ...
    with col_c:
        ...
        fig3 = px.line(
            ...
            color="Period",
            markers=True,
            color_discrete_map={"Current": "#d7f34a", "Prior Year": "#475569"},
    ...
    with col_f:
        ...
        fig_gm_trend.update_traces(fillcolor="rgba(96,165,250,0.12)", line_width=2)
...
with tab2:
    ...
    with col_g:
        ...
        fig4 = px.bar(
            ...
            orientation="h",
            color="revenue",
            color_continuous_scale=["#122033", "#60a5fa"],
